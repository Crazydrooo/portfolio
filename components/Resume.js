...
const Resume = ({ text }, ref) => {
  ...
  return (
    <div
      className="px-8 pt-16 pb-40 bg-gradient-to-l from-green-100 via-green-50 to-white"
      ref={ref}
    >
      <div className="mb-6 text-center">
        <h1 className="text-4xl text-emerald-800 font-semibold">{text}</h1>
      </div>
      <div className="flex flex-col items-center">
        <header className="w-auto flex flex-row mb-4 justify-center rounded-md bg-gradient-to-l from-green-100 via-green-50 to-white border-gray-500 border-2 lg:gap-4 lg:px-4">
          <button
