...
const Navbar = ({ handleClick }) => {
  ...
  return (
    <nav className="h-16 w-full flex justify-between shadow-md fixed z-10 items-center px-10 bg-gradient-to-r from-green-100 via-green-50 to-white">
      <div>
        <button
          className="flex transition rounded-md py-2 hover:text-emerald-600"
      ...
      >
        <li
          className="list-none w-full text-center p-4 hover:text-emerald-600 transition-all cursor-pointer"
          onClick={() => handleClick("hero")}
        >
          About
        </li>
